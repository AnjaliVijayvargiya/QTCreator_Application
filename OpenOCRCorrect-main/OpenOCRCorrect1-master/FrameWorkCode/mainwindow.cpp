...
{
    const QTextCharFormat::VerticalAlignment align = checked ?
                QTextCharFormat::AlignSuperScript : QTextCharFormat::AlignNormal;
    QTextCharFormat charFormat = ui->textBrowser->currentCharFormat();
    charFormat.setVerticalAlignment(align);
    ui->textBrowser->setCurrentCharFormat(charFormat);
}
